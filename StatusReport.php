...
if((isset($_GET['Year']) == TRUE) AND (isset($_GET['Quarter'])== TRUE) AND (isset($_GET['College'])== TRUE))  {
	...
	if ($College == "CAFAD"){
		echo "<script>
			window.location='Reports/Generate_SR_CAFAD.php?Year=$Year&Quarter=$Quarter&College=$College';
		</script>";
	}
	if ($College == "COE"){
		echo "<script>
			window.location='Reports/Generate_SR_COE.php?Year=$Year&Quarter=$Quarter&College=$College';
		</script>";
	}
	if ($College == "CICS"){
		echo "<script>
