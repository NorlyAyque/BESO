...
<table>
		...
		<tr>
			<td colspan="10">First Quarter, FY 2022</td>
		</tr>
		<tr>
			<td colspan="10">Campus:</td>
		</tr>
		<tr>
			<th width="168px";>Title of<br> Implementated<br> PPAs</th>
			<th width="110px">Date/<br>Duration</th>
		...
		<tr class="font">
			<td>1. CAPSTONE DEFENSE SUCCESS</td>
			<td>Feb 10-11, 2022</td>
			<td>Head count: 60 </td>
			<td>Lipa City Science Integrated National High School</td>
			<td>Virtual</td>
			<td>Mark Angel O. Lunar</td>
			<td>200</td>
			<td>200</td>
			<td>10000</td>
			<td>Extention Fud</td>
