	...
	<div class="container">
		...
		<div class="main">
			...
			<tr>
				...
				<th class="select"><label> <input type="radio" checked="checked" name="radio">Edit Target <label></th> 
				<th class="select1"><label> <input type="radio" checked="checked" name="radio">View Target <label></th> 
				<span class="checkmark"></span></p>
				<!--Save Button -->
				<th><button class="btn" type="submit" name="Login">Save</button></th>
			</tr>
			</thead>
			</table>
			<table class="target">
			...
			<tr>
				<td>PAP </td> 
				<td class="btn"><input type = "text" disabled> </td> 
